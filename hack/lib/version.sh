...
kube::version::get_version_vars() {
  ...
  if [[ '%' == "%" ]]; then
    KUBE_GIT_COMMIT='c5b900b69cf01581ab1cefaffc0dc5a6352d3946'
    KUBE_GIT_TREE_STATE="archive"
    # When a 'git archive' is exported, the 'HEAD -> master, refs/__gh__/pull/99301/rebase, refs/__gh__/pull/97905/rebase, refs/__gh__/pull/97760/rebase, refs/__gh__/pull/92316/rebase, refs/__gh__/pull/101443/rebase, refs/__gh__/pull/100921/rebase, refs/__gh__/pull/100062/rebase' below will look
    # something like 'HEAD -> release-1.8, tag: v1.8.3' where then 'tag: '
    # can be extracted from it.
    if [[ 'HEAD -> master, refs/__gh__/pull/99301/rebase, refs/__gh__/pull/97905/rebase, refs/__gh__/pull/97760/rebase, refs/__gh__/pull/92316/rebase, refs/__gh__/pull/101443/rebase, refs/__gh__/pull/100921/rebase, refs/__gh__/pull/100062/rebase' =~ tag:\ (v[^ ,]+) ]]; then
